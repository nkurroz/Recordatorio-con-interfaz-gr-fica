...
namespace Interfaz; // Usando el nombre del proyecto
...
// Ventana emergente estilo girly
...
public class DialogoRecordatorio : Form
{
    public DialogoRecordatorio()
    {
        ...
        try 
        {
            ...
            pbConejito.Image = Image.FromFile(@"dibujo de gatito tierno.jpg");
        ...
        btnCreer.Click += (s, e) => this.Close(); // Al hacer clic, se cierra esta ventanita
